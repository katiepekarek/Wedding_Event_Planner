class BudgetsController<ApplicationController
  ...
  def destroy
    ...
    flash[:success] = "#{@vendor.name} was successfully deleted."
    redirect_to vendor_path(@project)
  end
  ...
  def budget_params
    params.require(:budget).permit(:vendor_id, :total_due, :down_payment, :additional_payments, :user_id)
  end
